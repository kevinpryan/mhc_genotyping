...
hlamajority.in <- read.table("../../data/1000-genomes/benchmark-1000genomes-nfhlamajority-local-update-db-exclude-trim/benchmark-1000genomes-nfhlamajority-kourami-3-63-0-skip-trim-1002-samples/combined_results/nf_hlamajority_votes_combined_sorted.tsv", sep = "\t", header = T)
...
all.in.coverage <- read.table("../../data/1000-genomes/benchmark-1000genomes-nfhlamajority-local-update-db-exclude-trim/benchmark-1000genomes-nfhlamajority-kourami-3-63-0-skip-trim-1002-samples/combined_results/nf_hlamajority_depth_sorted.tsv", sep = "\t", header = T)
...
write.csv(full_stats, file = "data/results/hlamajority/1000-genomes-1002samples-full-stats-hlamajority-majority-vote.csv", row.names = F, quote = F)
saveRDS(benchmark_results, file = "data/results/hlamajority/1000-genomes-1002samples-full-results-hlamajority-majority-vote.Rds")
...
write.csv(final_df_score, file = "data/results/hlamajority/1000genomes-score-per-sample.csv", row.names = F, quote= F)
