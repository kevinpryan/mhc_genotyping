...
hlamajority.in <- read.table("../../data/raw/cell-lines-v2/majority/combined_results/nf_hlamajority_votes_combined_sorted.tsv", sep = "\t", header = T)
...
all.in <- read.table("../../data/raw/cell-lines-v2/majority/combined_results/nf_hlamajority_all_calls_sorted.tsv", sep = "\t", header = T)
...
outdir <- c("../../data/processed/cell-lines-v2/majority/")
...
all_results_hlamajority <- vroom("../../data/raw/cell-lines-v2/majority/combined_results/nf_hlamajority_votes_combined_sorted.tsv")
